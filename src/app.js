...
function doTheThing(gui) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('before generate - ' + gui);
                    return [4 /*yield*/, gui.generateEverything()];
                case 1:
                    _a.sent();
                    console.log('after generate - ' + gui);
                    return [4 /*yield*/, gui.downloadSTL()];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
var tensorField = new tensor_field_gui_1.default(true, noiseParamsPlaceholder);
var gui = new main_gui_1.default(tensorField);
doTheThing(gui)
